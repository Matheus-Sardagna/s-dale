...
//.contains só se for no começo da palavra = true            exemplo: abcd  = ab ---> true // abcd = cd -----> false
    ...
    public static void exe10(){
        Scanner in = new Scanner(System.in);
        System.out.println("Informe a quantidade de valor que você quer na primeira lista: ");
        int nmr1 = in.nextInt();

        int[] numeros1 = new int[nmr1];


        for (int i = 0; i < nmr1 ; i++){
            System.out.println("Insira os numeros: ");
            numeros1[i] = in.nextInt();
        }
        System.out.println("informe a quantidade de valor que você quer na segunda lista: ");
        int nmr2 = in.nextInt();
        int[] numeros2= new int[nmr2];

        for (int i = 0;i < nmr2; i++){
            System.out.println("Insira os numeros da segunda lista: ");
